...
public class Prjava43chirvechess21 extends Frame
   ...
   public Prjava43chirvechess21 () {
      ...
      setTitle("nova finestra prjava43chirvechess21");  // "this" Frame sets title
   ...
   public static void main(String[] args) {
      new Prjava43chirvechess21();  // Let the construct do the job
   }
